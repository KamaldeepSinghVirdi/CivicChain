...
function UserDashboard() {
  ...
  const navItems = [
    ...
    { path: '/user/my-grievances', icon: FiList, label: 'My Grievances' },
    { path: '/user/submit', icon: FiPlusCircle, label: 'Submit Grievance' },
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      `}>
        <div className="p-6">
          ...
          <p className="text-sm text-blue-200 mt-1">User Panel</p>
        </div>
        ...
        <header className="bg-white shadow-sm px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              <img 
                src="https://images.unsplash.com/photo-1494790108777-466d853a4a1b?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" 
                alt="User" 
